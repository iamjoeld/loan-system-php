...
<div class="form-row">
	<div class="form-group col-xl-6 col-md-6">
		<p>Montly Amount: <strong>UGX. <?php echo number_format($monthly, 2)?></strong></p>
		<p>Penalty: <strong>UGX. <?php echo number_format($add, 2)?></strong></p>
		<p>Payable Amount: <strong>UGX. <?php echo number_format($monthly+$add, 2)?></strong></p>
	</div>
	<div class="form-group col-xl-6 col-md-6">
		<label>Amount<label>
